...
urlpatterns = [
    ...
    path('product/<int:product_pk>/editproduct/getnameColorEdit/', views.getnameColorEdit, name ='getnameColorEdit'),
    path('product/<int:product_pk>/editproduct/getnameSizeEdit/', views.getnameSizeEdit, name ='getnameSizeEdit'),
